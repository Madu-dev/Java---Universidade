...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Informe o valor de X1 e Y1 (informe ambos e entre eles coloque um espa�o): ");
		...
		System.out.println("Informe o valor de X2 e Y2 (informe ambos e entre eles coloque um espa�o): ");
