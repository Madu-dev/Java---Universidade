//sistema para uma loja, como Cliente, Produto, Funcionário, Venda e Empresa
...
public class Main {
	...
	public static void main(String[] args) {
	    ...
	    System.out.println("Informe se é matriz ou filial: ");
	    ...
	    while(op == false){
	      ...
	      switch(resposta){
	        case 1: 
	          ...
	          if(respostaFuncionario == 1){
	            if(posFuncionarios == 10){
	              System.out.println("Número maximo de funcionarios criados !");
	            }
	            else{
	            ...
	            if(posFuncionarios == 0){
	              System.out.println("Primeiro é necessario criar pelo menos um funcionario.");
	            }
	            else{
	        ...
	        case 4:
	          ...
	          op = true;
	          break;
	        default: System.out.println("Opção Inválida escolha entre 1 a 4");
	          break;
	      }
	    }
	  }
