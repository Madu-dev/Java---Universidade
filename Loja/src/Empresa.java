public class Empresa {
	...
	public Empresa(String endereco, String cidade, String telefone, String email, boolean matriz, Funcionario gerente,
			Funcionario[] funcionarios, Produto[] produtos, Cliente[] clientes) {
